  ...
  function r(r, i) {
    ...
    if (!r.hasClass('revslider-initialised')) {
      ...
      r.find('.tp-caption').each(function (n) {
        try {
          if (
            (e(this).data('ytid') != t || e(this).find('iframe').attr('src').toLowerCase().indexOf('youtube') > 0) &&
            x == 0
          ) {
            x = 1;
        ...
        try {
          if (
            (e(this).data('vimeoid') != t || e(this).find('iframe').attr('src').toLowerCase().indexOf('vimeo') > 0) &&
            T == 0
          ) {
            T = 1;
  ...
  var L = function (n, r, i, s, o, u) {
    ...
    if (f == 16) {
      ...
      s.find('.tp-half-one .defaultimg').wrap(
        '<div class="tp-papercut" style="width:' + B + 'px;height:' + F + 'px;"></div>'
      );
    ...
    if (f == 20) {
      ...
      o.find('.slotslide').each(function (t) {
        ...
        C.add(
          punchgs.TweenLite.to(n, 0.1, { force3D: 'auto', opacity: 0, delay: (t * 50) / 1e3 + (N / 1e3 - N / 1e4) }),
          0
        );
      });
    }
  ...
  var R = function (n, r) {
    ...
    n.find('.rs-slideloop').each(function () {
      ...
      if (n.data('timeline') == t) {
        ...
        u = u * r;
        n.data('timeline').append(
          new punchgs.TweenLite.fromTo(n, a, { force3D: 'auto', x: i, y: s }, { x: o, y: u, ease: f })
        );
        n.data('timeline').append(
          new punchgs.TweenLite.fromTo(
            n,
    ...
    n.find('.rs-pulse').each(function () {
      ...
      if (n.data('timeline') == t) {
        ...
        n.data('timeline').append(
          new punchgs.TweenLite.fromTo(n, s, { force3D: 'auto', scale: r }, { scale: i, ease: o })
        );
        n.data('timeline').append(
          new punchgs.TweenLite.fromTo(
            n,
          ...
          case 'mousemove':
            ...
            i.find('.tp-parallax-container').each(function () {
              ...
              if (n.parallax == 'scroll+mouse' || n.parallax == 'mouse+scroll')
                punchgs.TweenLite.to(t, 0.4, { force3D: 'auto', x: i, ease: punchgs.Power3.easeOut, overwrite: 'all' });
              else
                punchgs.TweenLite.to(t, 0.4, {
                  force3D: 'auto',
                  x: i,
