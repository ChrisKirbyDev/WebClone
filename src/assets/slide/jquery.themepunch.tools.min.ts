        ...
        if (this._time !== o || i) {
          if (!this._initted) {
            ...
            if (
              ...
              return (
                (this._time = this._totalTime = o), (this._rawPrevTime = h), z.push(this), (this._lazy = [t, e]), void 0
              );
            this._time && !s
    ...
    function (t, e, i) {
      ...
      return (
        ...
        (m.staggerFrom = function (t, e, i, s, r, n, a, o) {
          return (
            (i.immediateRender = 0 != i.immediateRender), (i.runBackwards = !0), this.staggerTo(t, e, i, s, r, n, a, o)
          );
        }),
              ...
              o &&
                (this._gc ||
                  ((f === this._startTime || m !== this._timeScale) &&
                    ...
                    !e &&
                      this.vars[o] &&
                      this.vars[o].apply(this.vars[o + 'Scope'] || this, this.vars[o + 'Params'] || _))));
          }
        }),
    ...
    function (t, e) {
      ...
      var h,
        ...
        Y = (function () {
          ...
          return (
            (f =
              -1 !== F.indexOf('Safari') && -1 === F.indexOf('Chrome') && (-1 === e || Number(F.substr(e + 8, 1)) > 3)),
            (_ = f && 6 > Number(F.substr(F.indexOf('Version/') + 8, 1))),
            (p = -1 !== F.indexOf('Firefox')),
            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(F) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(F)) &&
        ...
        G = (E.convertToPixels = function (t, i, r, s, n) {
          ...
          if ((_ && (r = -r), '%' === s && -1 !== i.indexOf('border')))
            ...
            if (
              ((p.cssText = 'border:0 solid red;position:' + H(t, 'position') + ';line-height:0;'),
              '%' !== s && f.appendChild)
            )
          ...
          return u
            ? (s = e
                ? function (t) {
                    ...
                    if (
                      ((e = (t.match(le) || [n])[0]), (p = t.split(e).join('').match(g) || []), (_ = p.length), u > _--)
                    )
              ...
              ? (a.l++,
                ...
                o > 0
                  ? ((a.data['xn' + o] = e + i),
                    ...
                    (a['xn' + o] = e),
                    a.plugin ||
                      ((a.xfirst = new pe(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, s, a.pr)), (a.xfirst.xs0 = 0)),
                    a)
      ...
      var ve,
        ...
        Ae = (E.getTransform = function (t, e, i, r) {
          ...
          if (
            ...
            if (16 === o.length) {
              ...
              if (
                (y.zOrigin &&
                  ((z = -y.zOrigin), (D = C * z - o[12]), (N = k * z - o[13]), (z = A * z + y.zOrigin - o[14])),
              ...
              (y.x = o[4] || 0),
                ...
                Math.abs(c) > 90 &&
                  270 > Math.abs(c) &&
                  (x
                    ? ((f *= -1), (c += 0 >= _ ? 180 : -180), (_ += 0 >= _ ? 180 : -180))
                    : ((p *= -1), (c += 0 >= c ? 180 : -180))),
                (g = (_ - y.rotation) % 180),
                (v = (c - y.skewX) % 180),
                (void 0 === y.skewX ||
          ...
          if (p) {
            ...
            if (
              ...
              v
                ? ((_ = m / 2),
                  (d = g / 2),
                  (T += ', Dx=' + (_ - (_ * o + d * l) + w) + ', Dy=' + (d - (_ * h + d * u) + b) + ')'))
              ...
              for (
                ...
                (S = J[ce]),
                  ...
                  (R =
                    i !== r[S] ? (2 > ce ? -r.ieOffsetX : -r.ieOffsetY) : 2 > ce ? _ - r.ieOffsetX : d - r.ieOffsetY),
        ...
        Me = (E.set3DTransformRatio = function (t) {
          ...
          if (C || S.skewX)
            (y = Math.cos(C)),
              ...
              S.skewX &&
                ...
                (x = Math.sin(C)),
                'simple' === S.skewType &&
                  ((T = Math.tan(S.skewX * M)), (T = Math.sqrt(1 + T * T)), (y *= T), (x *= T))),
              (i = -x),
              (a = y);
          else {
          ...
          (f = 1),
            ...
            S.svg &&
              ((s += S.xOrigin - (S.xOrigin * e + S.yOrigin * i)), (l += S.yOrigin - (S.xOrigin * n + S.yOrigin * a))),
          ...
          parser: function (t, e, i, r, n, o, l) {
            ...
            for (
              be && null != x.force3D && ((m.force3D = x.force3D), (c = !0)),
                ...
                _ =
                  m.force3D || m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective,
      ...
      (l = a.prototype),
        ...
        (l._onInitTween = function (t, e, o) {
          ...
          if (
            (u &&
              '' === w.zIndex &&
              ((l = H(t, 'zIndex', s)), ('auto' === l || '' === l) && this._addLazySet(w, 'zIndex', 0)),
            'string' == typeof e &&
              ((d = w.cssText),
              (l = Z(t, s)),
              (w.cssText = d + ';' + e),
              ...
              x = 3 === this._transformType,
                xe
                  ? f &&
                    ((u = !0),
                    '' === w.zIndex &&
                      ((v = H(t, 'zIndex', s)), ('auto' === v || '' === v) && this._addLazySet(w, 'zIndex', 0)),
                    _ &&
                      this._addLazySet(
                        w,
                  ...
                  'color' === a || 'fill' === a || 'stroke' === a || -1 !== a.indexOf('Color') || (m && b.test(_))
                    ...
                    ? ((u = parseFloat(p)),
                      ...
                      (!u && 0 !== u) || (!f && 0 !== f)
                        ...
                        : ((i = new pe(v, a, u, f - u, i, 0, a, h !== !1 && ('px' === d || 'zIndex' === a), 0, p, _)),
                          (i.xs0 = d)))
  ...
  var e = t.GreenSockGlobals || t,
    ...
    y = function (t, e, i, s, o) {
      ...
      var l,
        ...
        te = [];
      for (
        W && (H = H.split('++').join('')), Z && (R = R.split('<').join('{{LT}}')), l = R.length, f = V(), d = 0;
        l > d;
        d++
      )
