  ...
  if (!e.TweenLite) {
                  ...
                  ? 'string' != typeof f
                    ? f.length && f !== a && f[0] && (f[0] === a || (f[0].nodeType && f[0].style && !f.nodeType))
                      ...
                      : ((this._siblings[e] = Z(f, this, !1)),
                        1 === i && this._siblings[e].length > 1 && _(f, this, null, 1, this._siblings[e]))
    ...
    var Z = function (a, b, c) {
        var d,
          ...
          f = a._gsTweenID;
        if (
          (R[f || (a._gsTweenID = f = 't' + S++)] || (R[f] = { target: a, tweens: [] }),
          ...
          return k
            ? (e = b
                ? function (a) {
                    ...
                    if (
                      ((b = (a.match(pa) || [f])[0]), (m = a.split(b).join('').match(u) || []), (n = m.length), k > n--)
                    )
