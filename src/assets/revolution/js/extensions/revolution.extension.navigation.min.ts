  ...
  jQuery.extend(!0, b, {
          ...
          i.find('.tp-bullet').each(function (a) {
            ...
            'vertical' === h.direction
              ? (b.css({ top: (c - 1) * e + 'px', left: '0px' }),
                i.css({ height: (c - 1) * e + b.outerHeight(), width: b.outerWidth() }))
    ...
    createNavigation: function (a, f) {
      ...
      h(a, f),
        ...
        ('on' === f.navigation.touch.touchOnDesktop || ('on' == f.navigation.touch.touchenabled && c)) &&
          k(a, f, 'swipebased');
    },
  });
  var e = function (a, b) {
    ...
    k = function (a, d, e) {
      ...
      var h = (c || b.get_browser(), a),
        i =
          'vertical' === d.navigation.thumbnails.direction || 'vertical' === d.navigation.tabs.direction
            ? 'none'
            : 'vertical',
          ...
          swipeStatus: function (e, g, h, i, l, m, n) {
            ...
            if (
              ...
              switch (
                ...
                case 'start':
                  void 0 !== f.positionanim &&
                    ...
                    (f.slide_globaloffset =
                      'off' === f.infinity ? f.slide_offset : b.simp(f.slide_offset, f.maxwidth))),
                    (f.overpull = 'none'),
                ...
                case 'move':
                  if (
                    ...
                    (f.slide_offset =
                      'off' === f.infinity ? f.slide_globaloffset + i : b.simp(f.slide_globaloffset + i, f.maxwidth)),
                    'off' === f.infinity)
                  ) {
                    var t =
              ...
              if (
                ...
                if ('end' == g && !s) {
                  if (
                    ((d.sc_indicator = 'arrow'), ('horizontal' == k && 'left' == h) || ('vertical' == k && 'up' == h))
                  )
      ...
      n(b.navigation.arrows) &&
        ...
        n(b.navigation.bullets) &&
          punchgs.TweenLite.delayedCall(
            c ? b.navigation.bullets.hide_delay_mobile : b.navigation.bullets.hide_delay,
            p,
            [d.find('.tp-bullets'), b.navigation.bullets, 'hide']
          ),
        n(b.navigation.thumbnails) &&
          punchgs.TweenLite.delayedCall(
            c ? b.navigation.thumbnails.hide_delay_mobile : b.navigation.thumbnails.hide_delay,
            p,
    ...
    t = function (a, b, c) {
      ...
      if (
        ...
        h > e && 'outer-left' !== b.position && 'outer-right' !== b.position
          ? (punchgs.TweenLite.set(a, { left: '0px', x: 0, maxWidth: e - 2 * g + 'px' }),
    ...
    u = function (a, b, c, d) {
      ...
      'vertical' === b.direction
        ...
        : (h.css({ left: (i - 1) * j + 'px', top: '0px' }),
          e.css({ width: (i - 1) * j + h.outerWidth(), height: h.outerHeight() })),
    ...
    w = function (a, b, c, d, e) {
      ...
      u.find(j).css({ backgroundImage: 'url(' + e.thumbs[c.index()].src + ')' }),
        'vertical' === b.direction
          ? (u.css({ top: (v - 1) * x + 'px', left: '0px' }),
            p.css({ height: (v - 1) * x + u.outerHeight(), width: u.outerWidth() }))
          : (u.css({ left: (v - 1) * w + 'px', top: '0px' }),
            p.css({ width: (v - 1) * w + u.outerWidth(), height: u.outerHeight() })),
        n.data('maxw', q),
        n.data('maxh', r),
      ...
      o.css({ maxWidth: q + 'px', maxHeight: r + 'px', overflow: 'hidden', position: 'relative' }),
        ...
        u.click(function () {
          ...
          (b = void 0 === b ? 0 : b),
            Math.abs(b) < 10 &&
              (a.revcallslidewithid(m), a.parent().find(f).removeClass('selected'), jQuery(this).addClass('selected'));
        }),
