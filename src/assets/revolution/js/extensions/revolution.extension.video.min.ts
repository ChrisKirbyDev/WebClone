...
!(function (e) {
  ...
  var I = jQuery.fn.revolution,
    ...
    S =
      (I.is_android(),
      { alias: 'Video Min JS', name: 'revolution.extensions.video.min.js', min_core: '5.4.8', version: '2.2.2' });
  function j(e) {
    return null == e
      ? -1
      : jQuery.isNumeric(e)
            ...
            A(
              ...
              (function (e) {
                ...
                var t = j(e.data('videostartat')),
                  a = s.currentTime;
                1 == e.data('nextslideatend-triggered') && ((a = -1), e.data('nextslideatend-triggered', 0)),
            ...
            i.find(f).each(function (e) {
              ...
              a.parent().hasClass('html5vid') ||
                ...
                1 != a.parent().data('metaloaded') &&
                  A(this, 'loadedmetadata', (Q((t = i), o), void I.resetVideo(t, o)));
            });
          break;
        case 'youtube':
          (m = 'https'),
            'none' == c &&
              -1 == (d = d.replace('controls=1', 'controls=0')).toLowerCase().indexOf('controls') &&
              (d += '&controls=0'),
            (!0 === a.videoinline ||
              'true' === a.videoinline ||
              1 === a.videoinline ||
      ...
      if (
        ...
        switch (l.videotype) {
          ...
          case 'vimeo':
            ...
            u = (u = null != p.player_id ? u.replace(p.player_id, a) : u + '&player_id=' + a).replace(
              /&api=0|&api=1/g,
              ''
            );
            var m = I.is_mobile(),
            ...
            (g = 'on' === g || 'true' === g || !0 === g) &&
              y &&
              ((u += '?autoplay=1&autopause=0&muted=1&background=1&playsinline=1'),
                ...
                if (
                  ...
                  if (d) {
                    ...
                    1 == r.data('nextslideatend') &&
                      (r.data('nextslideatend-triggered', 1), r.data('nextslidecalled', 1), o.c.revnext()),
                      h.pause();
              }),
    ...
    Q = function (o, d, e) {
      ...
      null != p &&
        ...
        A(r, 'timeupdate', function () {
          ...
          if (
            (null != m && (m.value = e),
            0 != t && -1 != t && Math.abs(t - a) <= 0.3 && a < t && 1 != o.data('nextslidecalled'))
          )
            if (l) {
              r.play();
        ...
        A(r, 'pause', function (e) {
          ...
          null != a && (a.innerHTML = 'Play'),
            (null != d.currentLayerVideoIsPlaying && d.currentLayerVideoIsPlaying.attr('id') != o.attr('id')) ||
