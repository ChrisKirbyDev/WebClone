...
!(function (e) {
  ...
  jQuery.extend(!0, A, {
        ...
        if (((i.inframeindex = 0), (i.outframeindex = -1), (i.hoverframeindex = -1), void 0 !== i.frames))
          for (var s = 0; s < i.frames.length; s++)
            void 0 !== i.frames[s].sfx_effect &&
              ...
              (0 === s ? ((i.frames[s].from = 'o:0'), (i.frames[s].to = 'o:1')) : (i.frames[s].to = 'o:0'),
              (i._sfx = 'block')),
    ...
    prepareSingleCaption: function (e) {
      ...
      if (
        ...
        (i._lig =
          void 0 === i._lig
            ...
            : i._lig),
        (i._column =
          void 0 === i._column ? (t.hasClass('rev_column_inner') ? t.closest('.rev_column') : 'none') : i._column),
        ...
        (i._cbgc_auto =
          void 0 === i._cbgc_auto ? 'column' === i._nctype && i._pw.find('.rev_column_bg_auto_sized') : i._cbgc_auto),
        (i._cbgc_man =
          void 0 === i._cbgc_man ? 'column' === i._nctype && i._pw.find('.rev_column_bg_man_sized') : i._cbgc_man),
        (i._slideid = i._slideid || t.closest('.tp-revslider-slidesli').data('index')),
        (i._id = void 0 === i._id ? t.data('id') || t.attr('id') : i._id),
        (i._slidelink =
          void 0 === i._slidelink ? void 0 !== t.hasClass('slidelink') && t.hasClass('slidelink') : i._slidelink),
        void 0 === i._li &&
      ...
      if (
        ('off' ===
          (void 0 === i.visibility ? 'oon' : N(i.visibility, a)[a.forcedWinRange] || N(i.visibility, a) || 'ooon') ||
        ...
        var l = d.data('ww'),
          ...
          g =
            'full' === (l = N(d.data('ww'), a)[a.curWinRange] || N(d.data('ww'), a) || 'auto') ||
            'full-proportional' === l,
          u =
            'full' === (m = N(d.data('hh'), a)[a.curWinRange] || N(d.data('hh'), a) || 'auto') ||
            'full-proportional' === m;
      ...
      D(t, '.frontcorner', 'left', 'borderRight', 'borderTopColor', T, k),
        ...
        'block' === i._sfx &&
          void 0 === i._bmask &&
          ((i._bmask = jQuery('<div class="tp-blockmask"></div>')), i._mw.append(i._bmask)),
        (i.arrobj = new Object()),
      ...
      'on' == a.fullScreenAlignForce && ((z = a.ulw), (O = a.ulh)),
        'none' !== i._lig &&
          null != i._lig &&
          ((z = i._lig.width()), (O = i._lig.height()), (e.offsetx = 0), (e.offsety = 0)),
        (I =
          'center' === I || 'middle' === I
            ? z / 2 - i.eow / 2 + C
            : 'left' === I
      ...
      if ('row' !== i._nctype && 'column' !== i._nctype)
        punchgs.TweenLite.set(i._pw, { zIndex: Q, top: i.calcy, left: i.calcx, overwrite: 'auto' });
      else if ('row' !== i._nctype)
        punchgs.TweenLite.set(i._pw, { zIndex: Q, width: i.columnwidth, top: 0, left: 0, overwrite: 'auto' });
      else if ('row' === i._nctype) {
      ...
      if (
        ...
        'row' === i._nctype &&
          (i.columnbreak <= a.curWinRange ? t.addClass('rev_break_columns') : t.removeClass('rev_break_columns')),
        ...
        if (
          ...
          if (
            ...
            null != n.hoveranim.anim.color &&
              ((d.anim.fill = n.hoveranim.anim.color), (n.idlesvg.anim.css.fill = o.svg.css('fill'))),
              (n.hoversvg = d);
          }
          a.hover(
            function (e) {
        ...
        for (var l = 0; l < n.frames.length; l++)
          if (l !== n.hoverframeindex) {
            ...
            void 0 !== t.firstslide &&
              ...
              jQuery.isNumeric(p)
                ? i.addLabel(m, '+=' + p)
                : (i.addLabel('pause_' + l, '+=0.01'), i.addPause('pause_' + l), i.addLabel(m, '+=0.01')),
    ...
    createFrameOnTimeline: function (e) {
      ...
      if (0 !== r || e.fromcurrentstate)
        ...
        n.add(
          d.content.staggerFromTo(s, 0.05, { x: 0, y: 0, autoAlpha: 0 }, { x: 0, y: 0, autoAlpha: 1, delay: x }),
          a
        );
      else if (u && void 0 !== L) {
        ...
        void 0 !== i.frames[r].color &&
          ((b.anim.color = i.frames[r].color), (_.anim.color = i.cssobj.styleProps.color)),
          void 0 !== i.frames[r].bgcolor &&
      ...
      return (
        ...
        i._gsTransformTo &&
          r === m &&
          i.hoveredstatus &&
          (i.hovertimelines.item = punchgs.TweenLite.to(t, 0, i._gsTransformTo)),
        (i._gsTransformTo = !1),
    ...
    endMoveCaption: function (e) {
      ...
      if (
        ...
        for (var a = 0; a < t.timeline_obj.dchildren.length; a++)
          A.endMoveCaption({ caption: jQuery(t.timeline_obj.dchildren[a]), opt: e.opt });
    },
  ...
  var O = function (e, t, i, a, n, r, o, s, d) {
      ...
      if (
        ...
        'enterstage' === l.eventtype &&
          ((a.animdirection = 'in'), (a.visibleelement = !0), A.toggleState(a.layertoggledby)),
        ...
        if (0 === e) for (var m = 0; m < t.dchildren.length; m++) jQuery(t.dchildren[m]).data('timeline').play(0);
          ...
          for (m = 0; m < t.dchildren.length; m++)
            A.endMoveCaption({ caption: jQuery(t.dchildren[m]), opt: d, checkchildrens: !0 });
    ...
    B = function (e) {
      return (
        ...
        (e['-webkit-filter'] =
          void 0 === e['-webkit-filter'] ? 'blur(0px) grayscale(0%) brightness(100%)' : e['-webkit-filter']),
        e
      );
    },
    u = function () {
          ...
          : (e =
              'top' ===
                (e =
                  'left' ===
                    (e =
                      'layer_top' === (e = 'layer_left' === e ? 0 - i : 'layer_right' === e ? i : e)
                        ? 0 - a
                        : 'layer_bottom' === e
                        ? a
                        : e) || 'stage_left' === e
          ...
          jQuery.each(i, function (e, t) {
            ...
            r &&
              ...
              null != n &&
                ...
                'fg' == a &&
                  (l = '' === l ? 'grayscale(' + parseInt(n, 0) + '%)' : l + ' grayscale(' + parseInt(n, 0) + '%)'),
                'fbr' == a &&
                  (l = '' === l ? 'brightness(' + parseInt(n, 0) + '%)' : l + ' brightness(' + parseInt(n, 0) + '%)'),
  ...
  var v = function (a, e) {
      ...
      var t = (e = (e = (e = (e = (e = (e = (e = (e = e.replace('c:', 'color:')).replace(
        'bg:',
        'background-color:'
      )).replace('bw:', 'border-width:')).replace('bc:', 'border-color:')).replace('br:', 'borderRadius:')).replace(
        'bs:',
        'border-style:'
      ...
      return (
        t &&
          jQuery.each(t, function (e, t) {
            var i = t.split(':');
            0 < i[0].length &&
              ('background-color' === i[0] && 0 <= i[1].indexOf('gradient') && (i[0] = 'background'),
              (a.anim[i[0]] = i[1]));
          }),
        a
      );
    ...
    V = function (e, t) {
      ...
      if (
        ...
        (a.paddingBottom =
          void 0 === e.data('paddingbottom') ? parseInt(e.css('paddingBottom'), 0) || 0 : e.data('paddingbottom')),
        (a.paddingLeft =
          void 0 === e.data('paddingleft') ? parseInt(e.css('paddingLeft'), 0) || 0 : e.data('paddingleft')),
        (a.paddingRight =
          void 0 === e.data('paddingright') ? parseInt(e.css('paddingRight'), 0) || 0 : e.data('paddingright')),
        (a.marginTop = void 0 === e.data('margintop') ? parseInt(e.css('marginTop'), 0) || 0 : e.data('margintop')),
        (a.marginBottom =
          void 0 === e.data('marginbottom') ? parseInt(e.css('marginBottom'), 0) || 0 : e.data('marginbottom')),
        (a.marginLeft = void 0 === e.data('marginleft') ? parseInt(e.css('marginLeft'), 0) || 0 : e.data('marginleft')),
        (a.marginRight =
          void 0 === e.data('marginright') ? parseInt(e.css('marginRight'), 0) || 0 : e.data('marginright')),
        (a.borderTopWidth =
          void 0 === e.data('bordertopwidth') ? parseInt(e.css('borderTopWidth'), 0) || 0 : e.data('bordertopwidth')),
        (a.borderBottomWidth =
        ...
        (a.maxWidth = void 0 === e.data('width') ? parseInt(e.css('maxWidth'), 0) || 'none' : e.data('width')),
          ...
          (a.moan =
            void 0 === e.data('moan') ? parseInt(e.css('-moz-animation-transition'), 0) || 'none' : e.data('moan')),
    ...
    E = function (e, t, i, a) {
      ...
      if (
        ...
        if (
          ...
          (void 0 !== e.data('transform_hover') || void 0 !== e.data('style_hover')) &&
    ...
    c = function (e, t) {
      ...
      if (e.hasClass('rs-slideloop') && null == i._loop_timeline) {
        ...
        (d *= t),
          ...
          (c *= t),
          i._loop_timeline.append(
            new punchgs.TweenLite.fromTo(e, r, { force3D: 'auto', x: d, y: l }, { x: m, y: c, ease: s })
          ),
          i._loop_timeline.append(
            new punchgs.TweenLite.fromTo(
              e,
      ...
      if (e.hasClass('rs-pulse') && null == i._loop_timeline) {
        ...
        (r = null == e.data('speed') ? 2 : e.data('speed')),
          (s = null == e.data('easing') ? punchgs.Power2.easeInOut : e.data('easing'));
        i._loop_timeline.append(
          new punchgs.TweenLite.fromTo(e, r, { force3D: 'auto', scale: p }, { scale: g, ease: s })
        ),
          i._loop_timeline.append(
            new punchgs.TweenLite.fromTo(
              e,
