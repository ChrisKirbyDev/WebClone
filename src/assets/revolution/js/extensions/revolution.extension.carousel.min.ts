...
!(function (a) {
  ...
  jQuery.extend(!0, b, {
    ...
    organiseCarousel: function (a, b, c, d) {
      ...
      for (
        var e = a.carousel, f = new Array(), g = e.slides.length, i = ('right' === e.horizontal_align ? a.width : 0, 0);
        i < g;
        i++
      ) {
          ...
          void 0 !== e.maxRotation &&
            ...
            ('on' === e.vary_rotation
              ? ((j.rotationY =
                  ...
                  Math.abs((1 - Math.abs((1 / Math.ceil(e.maxVisibleItems / n)) * l)) * e.maxRotation)),
          ...
          onComplete: function () {
            (g.slide_globaloffset =
              'off' === g.infinity
                ...
                : b.simp(g.slide_globaloffset + g.slide_offset_target, g.maxwidth)),
              (g.slide_offset = b.simp(g.slide_offset, g.maxwidth)),
