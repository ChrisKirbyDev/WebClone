...
!(function (jQuery, undefined) {
  ...
  jQuery.fn.extend({
          ...
          (i.minHeight = i.minHeight != undefined ? parseInt(i.minHeight, 0) : i.minHeight),
            ...
            i.navigation != undefined &&
              ...
              (i.navigation.touch.swipe_min_touches =
                5 < i.navigation.touch.swipe_min_touches ? 1 : i.navigation.touch.swipe_min_touches),
    ...
    revaddcallback: function (e) {
      return this.each(function () {
        this.opt &&
          (this.opt.callBackArray === undefined && (this.opt.callBackArray = new Array()),
  ...
  jQuery.extend(!0, _R, {
      ...
      return (
        ...
        'stop' != e.check &&
          (_R.getversion().core < e.min_core
            ? (e.check === undefined &&
                (console.log(
                  '%cSlider Revolution Warning (Core:' + _R.getversion().core + ')',
    ...
    isSafari11: function () {
      ...
      return (
        -1 === jQuery.trim(navigator.userAgent.toLowerCase()).search('edge') && 'msie' !== e && e.match(/safari|chrome/)
      );
    },
  ...
  var _ISM = _R.is_mobile(),
          ...
          ? (e.find('img').each(function () {
            ...
            e.find('.tp-caption, .tp-static-layer, .rs-background-video-layer').each(function () {
              ...
              (e.data('ytid') != undefined ||
                (0 < e.find('iframe').length && 0 < e.find('iframe').attr('src').toLowerCase().indexOf('youtube'))) &&
                (i.videos = !0),
    ...
    getScriptLocation = function (e) {
      ...
      return (
        ...
        (t = (t = (t = t.replace('jquery.themepunch.revolution.min.js', '')).replace(
    ...
    prepareOptions = function (e, i) {
      (i.carousel.maxVisibleItems = i.carousel.maxVisibleItems < 1 ? 999 : i.carousel.maxVisibleItems),
        (i.carousel.vertical_align =
          'top' === i.carousel.vertical_align ? '0%' : 'bottom' === i.carousel.vertical_align ? '100%' : '50%');
    },
        ...
        jQuery.each(x.allli, function (e, i) {
          ...
          (n.params = new Array()),
            ...
            i.data('title') !== undefined &&
              n.params.push({ from: RegExp('\\{\\{title\\}\\}', 'g'), to: i.data('title') }),
            i.data('description') !== undefined &&
              n.params.push({ from: RegExp('\\{\\{description\\}\\}', 'g'), to: i.data('description') });
          for (a = 1; a <= 10; a++)
            i.data('param' + a) !== undefined &&
              n.params.push({ from: RegExp('\\{\\{param' + a + '\\}\\}', 'g'), to: i.data('param' + a) });
      ...
      if (
        ...
        (j.addedyt = 0),
          ...
          t.find('.tp-caption, .rs-background-video-layer').each(function (e) {
            ...
            if (
              ...
              n.hasClass('tp-no-events') && (w = ';pointer-events:none'),
                ...
                s &&
                  x.scrolleffect.on &&
                  (('on' === x.scrolleffect.on_parallax_layers && i.isparallaxlayer) ||
                    ('on' === x.scrolleffect.on_layers && !i.isparallaxlayer)) &&
          ...
          x.allli.each(function (e) {
            ...
            (x.rowzones[e] = []),
              ...
              ('all' != x.lazyType &&
                ('smart' != x.lazyType || (0 != e && 1 != e && e != x.slideamount && e != x.slideamount - 1))) ||
        ...
        t.append(
          ...
          0 === t.find('.tp-bannertimer').length &&
            t.append('<div class="tp-bannertimer" style="visibility:hidden"></div>'),
        ...
        (x.inviewport = !1),
          g != undefined &&
            ...
            (jQuery.isNumeric(g.visible_area) ||
              (-1 !== g.visible_area.indexOf('%') && (g.visible_area = parseInt(g.visible_area) / 100)),
          ...
          setTimeout(function () {
            ...
            _R.manageNavigation && _R.manageNavigation(x),
              1 < x.slideamount &&
                (!g.enable || (g.enable && x.inviewport) ? countDown(t, x) : (x.waitForCountDown = !0)),
              setTimeout(function () {
          ...
          if ('fullscreen' == x.sliderLayout) {
            ...
            ('mobile' == x.fallbacks.ignoreHeightChanges && _ISM) || 'always' == x.fallbacks.ignoreHeightChanges
              ? ((x.fallbacks.ignoreHeightChangesSize =
                  x.fallbacks.ignoreHeightChangesSize == undefined ? 0 : x.fallbacks.ignoreHeightChangesSize),
                (e = i != x.lastwindowheight && Math.abs(i - x.lastwindowheight) > x.fallbacks.ignoreHeightChangesSize))
              : (e = i != x.lastwindowheight);
          }
          (t.outerWidth(!0) != x.width || t.is(':hidden') || e) &&
            ((x.lastwindowheight = jQuery(window).height()), containerResized(t, x));
        }),
          hideSliderUnder(t, x),
          contWidthManager(x),
    ...
    checkHoverDependencies = function (e, n) {
      var i = e.data();
      ('sliderenter' === i.start ||
        (i.frames !== undefined && i.frames[0] != undefined && 'sliderenter' === i.frames[0].delay)) &&
      ...
      if (
        ...
        removeSlots(e, i, e, 2),
          'standard' === i.sliderType &&
            (punchgs.TweenLite.set(a.find('.defaultimg'), { opacity: 0 }), t.find('.defaultimg').css({ opacity: 1 })),
          ...
          'on' == a.data('kenburns') &&
            _R.startKenBurn(a, i, a.data('kbtl') !== undefined ? a.data('kbtl').progress() : 0),
          'on' == t.data('kenburns') &&
            _R.startKenBurn(t, i, t.data('kbtl') !== undefined ? t.data('kbtl').progress() : 0),
          _R.animateTheCaptions &&
            0 < e.find('.processing-revslide').length &&
    ...
    prepareSlides = function (e, u) {
      if (
        ...
        u.allli.each(function (e) {
          ...
          ((u.startWithSlide != undefined && t == u.startWithSlide) || (u.startWithSlide === undefined && 0 == e)) &&
        ...
        u.allli.find('>img').each(function (e) {
          ...
          i.closest('.slotholder').data(r),
            0 < a.length &&
              ...
              (a.data('bgparallax', r.bgparallax), a.data('showcoveronpause', 'on')),
          ...
          var c = document.createComment(
            'Runtime Modification - Img tag is Still Available for SEO Goals in Source - ' + i.get(0).outerHTML
          );
          i.replaceWith(c),
            d.data(r),
            d.attr('src', o),
            ('standard' !== u.sliderType && 'undefined' !== u.sliderType) || d.css({ opacity: 0 });
        }),
        u.scrolleffect.on &&
    ...
    waitForCurrentImages = function (o, s, e) {
      ...
      o.find('img,.defaultimg, .tp-svg-layer').each(function () {
          ...
          if ((e.attr('src', t.src), 'img' == t.type))
            if (e.hasClass('defaultimg'))
              _R.isIE(8)
                ...
                : (-1 == t.src.indexOf('images/transparent.png') && -1 == t.src.indexOf('assets/transparent.png')) ||
        ...
        if (
          (t &&
            ...
            (!t.error && jQuery.now() - e.data('start-to-load') < 5e3
              ? (l = !0)
              : ((t.progress = 'failed'),
                t.reported_img || ((t.reported_img = !0), console.warn(i + '  Could not be loaded !')))),
        ...
        if (
          1 == s.vimeoapineeded &&
          !window.Vimeo &&
          ((l = !0), 5e3 < jQuery.now() - s.vimeostarttime && 1 != s.vimeowarning)
        ) {
          s.vimeowarning = !0;
        ...
        jQuery.each(s.loadqueue, function (e, i) {
          !0 !== i.static ||
            ...
            ('failed' == i.progress
              ? i.reported ||
                ((i.reported = !0),
                console.warn('Static Image ' + i.src + '  Could not be loaded in time. Error Exists:' + i.error))
    ...
    swapSlide = function (e) {
      ...
      if (
        ('carousel' !== i.sliderType ||
          i.carousel.fadein ||
          (punchgs.TweenLite.to(i.ul, 1, { opacity: 1 }), (i.carousel.fadein = !0)),
    ...
    swapSlideProgress = function (e, i) {
      ...
      (o.sdir = d < l ? 1 : 0),
        'arrow' == o.sc_indicator &&
          (0 == l && d == o.slideamount - 1 && (o.sdir = 1), l == o.slideamount - 1 && 0 == d && (o.sdir = 0)),
    ...
    letItFree = function (e, i, t, a, n, r) {
      ...
      'carousel' === o.sliderType ||
        ...
        'on' == i.data('kenburns') &&
          (i.data('kbtl') != undefined ? (i.data('kbtl').timeScale(1), i.data('kbtl').play()) : _R.startKenBurn(i, o)),
      ...
      (t[0].tween = punchgs.TweenLite.fromTo(
        ...
        e.on('tp-mouseenter', function () {
          (i.mouseoncontainer = !0),
            'on' != i.navigation.onHoverStop || _ISM || (e.trigger('stoptimer'), e.trigger('revolution.slide.onpause'));
        }),
    ...
    getUrlVars = function (e) {
      for (
        var i, t = [], a = window.location.href.slice(window.location.href.indexOf(e) + 1).split('_'), n = 0;
        n < a.length;
        n++
      )
