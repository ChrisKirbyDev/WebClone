    ...
    },
    {
      ...
      run: function () {
        ...
        for (i = 0, n = this._clones.length + this._items.length; i < n; i++) {
          ...
          coordinate +=
            (this.settings.autoWidth ? this._items[this.relative(i)].width() + this.settings.margin : width * merge) *
            rtl;
...
(function ($, window, document, undefined) {
  ...
  Navigation.prototype.onTrigger = function (event) {
    ...
    event.page = {
      ...
      size:
        settings &&
        (settings.center || settings.autoWidth || settings.dotData ? 1 : settings.dotsEach || settings.items),
    };
  };
